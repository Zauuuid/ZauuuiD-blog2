      ...
      <div className="container mx-auto px-4 relative z-10 flex justify-center">
        ...
        >
          ...
          <motion.div
            ...
            className="w-40 h-40 rounded-full border border-white/30 p-[2px] mb-6 relative cursor-pointer shadow-[0_0_30px_rgba(255,255,255,0.2)] group-hover:shadow-[0_0_50px_rgba(255,255,255,0.4)] transition-shadow duration-500"
          >
            <img
          ...
          >
            {siteConfig.badges.map((badge, idx) => (
              <span key={idx} className={`px-4 py-1.5 rounded-full font-mono tracking-wider text-xs md:text-sm ${idx % 2 === 0
                  ? 'border border-gray-300/30 bg-gray-300/10 text-gray-200 shadow-[0_0_15px_rgba(255,255,255,0.1)]'
            ...
            {siteConfig.socials.map((link) => {
              ...
              return (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-white/50 hover:bg-white/10 hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-all duration-300 backdrop-blur-sm"
                >
                  <Icon size={22} />
                </motion.a>
              );
